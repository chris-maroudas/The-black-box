# RailsAdmin config file. Generated on March 07, 2014 04:03
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['The Noir Box', 'Admin']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your static_page.rb model definition
